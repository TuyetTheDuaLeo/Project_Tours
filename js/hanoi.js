...
function destination() {
    var description = document.querySelector('.section-destination');
    var currentElements = description.querySelectorAll('.currents');
    var showMore = document.querySelector('.show-more-2');

    for (var i = 0; i < currentElements.length; i++) {
        var computedStyle = window.getComputedStyle(currentElements[i]);
